...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2016 at 01:37 PM
...
(41, 'proposals', 'proposal-expiry-reminder', 'english', 'Proposal Expiration Reminder', 'Proposal Expiration Reminder', '<p>Hello&nbsp;{proposal_proposal_to}</p>\r\n<p>The proposal {proposal_subject} will expire on&nbsp;{proposal_open_till}</p>\r\n<p>You can view the proposal on the following link:&nbsp;{proposal_link}</p>\r\n<p>Regards,</p>\r\n<p>{email_signature}</p>', '{companyname} | CRM', '', 0, 1, 0),
...
INSERT INTO `tblinvoicepaymentsmodes` (`id`, `name`, `description`, `show_on_pdf`, `invoices_only`, `expenses_only`, `active`) VALUES
(1, 'Bank', NULL, 0, 0, 0, 1);
...
(41, 'automatically_send_invoice_overdue_reminder_after', '7'),
(42, 'automatically_resend_invoice_overdue_reminder_after', '3'),
(43, 'last_recurring_expenses_cron', ''),
...
(51, 'last_recurring_invoices_cron', ''),
(52, 'limit_top_search_bar_results_to', '10'),
(53, 'estimate_prefix', 'EST-'),
(54, 'next_estimate_number', '1'),
(55, 'estimate_number_decrement_on_delete', '1'),
(56, 'estimate_number_format', '1'),
(57, 'estimate_auto_convert_to_invoice_on_client_accept', '1'),
(58, 'exclude_estimate_from_client_area_with_draft_status', '1'),
(59, 'rtl_support_admin', '0'),
(60, 'last_cron_run', ''),
(61, 'show_sale_agent_on_estimates', '1'),
(62, 'show_sale_agent_on_invoices', '1'),
(63, 'predefined_terms_invoice', ''),
(64, 'leads_default_source', ''),
(65, 'default_contact_permissions', 'a:6:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";i:3;s:1:"4";i:4;s:1:"5";i:5;s:1:"6";}'),
(66, 'predefined_terms_estimate', ''),
(67, 'predefined_clientnote_invoice', ''),
(68, 'predefined_clientnote_estimate', ''),
(69, 'custom_pdf_logo_image_url', ''),
(70, 'number_padding_prefixes', '6'),
(71, 'favicon', 'favicon.ico'),
(72, 'auto_backup_enabled', '0'),
(73, 'invoice_due_after', '7'),
(74, 'google_api_key', ''),
...
(162, 'swap_pdf_info', '0'),
(163, 'pdf_text_color', '#000000'),
(164, 'auto_check_for_new_notifications', '0'),
(165, 'exclude_invoice_from_client_area_with_draft_status', '1'),
(166, 'cron_has_run_from_cli', '1'),
(167, 'hide_cron_is_required_message', '0'),
(168, 'dropbox_app_key', ''),
(169, 'auto_assign_customer_admin_after_lead_convert', '1'),
(170, 'default_task_priority', '2'),
(171, 'show_transactions_on_invoice_pdf', '1'),
(172, 'tasks_kanban_limit', '50'),
(173, 'show_pay_link_to_invoice_pdf', '1'),
(174, 'proposal_number_prefix', 'PRO-'),
(175, 'proposals_pipeline_limit', '50'),
(176, 'estimates_pipeline_limit', '50'),
(177, 'purchase_key', '');
