          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <?php } ?>
                ...
                <?php echo render_textarea('message['.$template->emailtemplateid.']','',$template->message,array(),array(),'','tinymce'); ?>
                <?php foreach($available_languages as $language){
                  ...
                  if(count($lang_template) > 0){
                    ...
                    echo render_textarea('message['.$lang_template['emailtemplateid'].']','',$lang_template['message'],array(),array(),'','tinymce');
                    echo '</div>';
                  }
                } ?>
