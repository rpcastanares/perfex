        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4><?php echo _l('billing_address'); ?> <a href="#" class="pull-right text-uppercase billing-same-as-customer"><small class="label label-primary inline-block"><?php echo _l('customer_billing_same_as_profile'); ?></small></a></h4>
                        <hr />
                    ...
                    <div class="col-md-6">
                        <h4>
                            ...
                            <?php echo _l('shipping_address'); ?> <a href="#" class="pull-right text-uppercase customer-copy-billing-address"><small class="label label-primary inline-block"><?php echo _l('customer_billing_copy'); ?></small></a></h4>
                            <hr />
