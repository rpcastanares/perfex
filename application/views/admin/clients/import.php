        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="row">
                        <div class="col-md-4 mtop15">
                            <?php echo form_open_multipart($this->uri->uri_string(),array('id'=>'upload_form')) ;?>
                            <!-- <?php //echo form_hidden('clients_upload','true'); ?> -->
                            <!-- <?php //echo render_input('txtSingleUpload','Choose VCF file','','file'); ?> -->
                            <div class="form-group"><label for="txtSingleUpload" class="control-label">Choose VCF file</label><input type="file" id="txtSingleUpload[]" name="txtSingleUpload[]" class="form-control" value="" multiple /></div>
                            <!-- <?php //echo render_select('groups_in[]',$groups,array('id','name'),'customer_groups',($this->input->post('groups_in') ? $this->input->post('groups_in') : array()),array('multiple'=>true,'data-none-selected-text'=>_l('dropdown_non_selected_tex'))); ?> -->
                            <!-- <?php //echo render_input('default_pass_all','default_pass_clients_import',$this->input->post('default_pass_all')); ?> -->
                            <div class="form-group">
                                <button type="button" class="btn btn-info import btn-upload-submit"><?php echo _l('upload'); ?></button>
                                <!-- <button type="button" class="btn btn-info simulate btn-import-submit"><?php echo _l('simulate_import'); ?></button> -->
                            </div>
                            <input type="hidden" id="importVCF" name="importVCF" value="1" />
                            <?php echo form_close(); ?>
                        </div>
                    </div>
                </div>
