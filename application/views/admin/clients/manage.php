                            ...
                            <a href="<?php echo admin_url('clients/client'); ?>" class="btn btn-info mright5 test pull-left display-block">
                                ...
                                <div class="row mbot15">
                                    ...
                                    <div class="col-md-2 col-xs-6 border-right">
                                        ...
                                        <span class="text-dark bold"><?php echo _l('customers_summary_total'); ?></span>
                                    </div>
                                      <div class="col-md-2 col-xs-6 border-right">
                                        <h3 class="bold"><?php echo total_rows('tblclients',array('active'=>1)); ?></h3>
                                        <span class="text-success bold"><?php echo _l('active_customers'); ?></span>
                                    </div>
                                         <div class="col-md-2 col-xs-6 border-right">
                                        <h3 class="bold"><?php echo total_rows('tblclients',array('active'=>0)); ?></h3>
                                        <span class="text-danger bold"><?php echo _l('inactive_active_customers'); ?></span>
                                    </div>
                                    <div class="col-md-2 col-xs-6 border-right">
