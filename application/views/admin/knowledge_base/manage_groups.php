                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div class="onoffswitch">
                                                <input type="checkbox" id="<?php echo $group['groupid']; ?>" data-id="<?php echo $group['groupid']; ?>" class="onoffswitch-checkbox" data-switch-url="<?php echo ADMIN_URL; ?>/knowledge_base/change_group_status" <?php if($group['active'] == 1){echo 'checked';} ?>>
